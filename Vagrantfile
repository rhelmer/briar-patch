...
Vagrant::Config.run do |config|
  ...
  # First, ensure that puppet is installed
  config.vm.provision :shell, :inline => "rpm -Uvh --force http://yum.puppetlabs.com/el/6/products/x86_64/puppetlabs-release-6-1.noarch.rpm"
